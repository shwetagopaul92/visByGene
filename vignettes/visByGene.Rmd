...
<div id="ecran" style='overflow:auto;height:300px'>
...
- Our R package visByGene is a preliminary attack on visualizing available experiment and annotation data to understand mechanisms of disease using R/Bioconductor (www.bioconductor.org) interfaces to high-resolution genomic data assembled in MongoDB, Bioconductor annotation packages, and tabix indexed files.

- This can unravel rare genomic events essential to understanding the etiology of complex diseases and developing innovative technical clinical solutions.
...
visByGene <- function(myeqtl, myfp, mytf, mysymbol){
  ...
  visplot = plotTracks(list(gtrack,biomtrack,dtrack1,dtrack2,dtrack3,itrack), sizes=c(3,7,5,6,6,6))
...
server = function(input, output, session){
  ...
  output$text1 <- renderText("Eric Tu, et al. Interactive Exploration on Large Genomic Datasets. 2016 Spring; 2016: UCB/EECS-2016-111, Matteo Gabetta, et al. BigQ: a NoSQL based framework to handle genomic variants in i2b2. BMC         Bioinformatics. 2015")
